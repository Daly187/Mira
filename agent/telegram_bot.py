...
class MiraTelegramBot:
    ...
    async def _cmd_help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        commands = (
            ...
            "INTELLIGENCE\n"
            "/dca — DCA position summary across instruments\n"
            "/compliance — Check compliance deadlines\n"
            "/compliance add [name] [date] [jurisdiction] — Add deadline\n"
            "/competitive — Run competitive intelligence scan\n"
            "/subscriptions — Audit active subscriptions\n"
            "/pnl — Monthly personal P&L report\n\n"
            "COST\n"
